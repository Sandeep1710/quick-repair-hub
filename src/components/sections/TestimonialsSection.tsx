          ...
          <div className="relative">
            ...
            <div className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 md:-translate-x-16 z-10">
              <Button
                ...
                className="rounded-full w-12 h-12 elegant-shadow border-2"
              >
            ...
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="bg-card rounded-2xl p-8 md:p-12 elegant-shadow-lg elegant-border relative"
              >
                {/* Quote Icon */}
                ...
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 rounded-full bg-primary flex items-center justify-center text-primary-foreground font-display font-semibold text-lg">
